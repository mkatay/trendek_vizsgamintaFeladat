class TestSuite {
    ...
    runHeaderTest() {
        ...
        const path=headerStyle.backgroundImage.match(/url\(['"]?([^'"]+)['"]?\)/)[1].split('/').slice(-2)
    ...
    runTitleTest() {
        ...
        console.log(h1Style.borderBottom);
    ...
    runUListTest() {
        ...
        const liStyle=window.getComputedStyle(liList[0])
    ...
    runSubtitleTest(){
        ...
        console.log(subTitleStyle.borderBottom);
